...
<title><s:text name="aplication.empleado.crear" /></title>
<link rel="stylesheet" type="text/css" href="../css/estilo.css">
</head>
<body>

	<div class="contenedor">
		<s:form action="crear" method="post" validate="true">
			<p>
				<s:text name="aplication.empleado.editar" />
			</p>
			<s:textfield name="empleado.usename" key="aplication.campo.username" />
			...
			<s:select name="empleado.departamento.id"
				key="aplication.campo.departamento" headerKey=""
				headerValue="%{getText('aplication.select.seleccionar')}"
