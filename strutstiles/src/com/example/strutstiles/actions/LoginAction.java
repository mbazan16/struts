...
import static com.example.strutstiles.commons.Constantes.ERROR_GENERAL;
import static com.example.strutstiles.commons.Constantes.PASSWORD_INCORRECTA;
import static com.example.strutstiles.commons.Constantes.USERNAME_INCORRECTO;
...
import com.example.strutstiles.services.GesLogin;
import com.example.strutstiles.services.GesLoginImpl;
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			if(USERNAME_INCORRECTO.equalsIgnoreCase(e.getClaveError())) {
				errores.add("username",new ActionMessage(e.getClaveError(),loginForm.get("username")));
